...
{
    if ( self.frame.origin.x != frame.origin.x || self.frame.origin.y != frame.origin.y || self.frame.size.width != frame.size.width || self.frame.size.height != frame.size.height ){
        return NO;
    }
    return YES;
}
